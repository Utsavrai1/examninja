...
class WebStudentTestScreen extends StatefulWidget {
  final String examId;
  final String marks;

  const WebStudentTestScreen(
      {super.key, required this.examId, required this.marks});

  @override
  State<WebStudentTestScreen> createState() => _WebStudentTestScreenState();
}

class _WebStudentTestScreenState extends State<WebStudentTestScreen> {
